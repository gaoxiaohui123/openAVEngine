...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--enable-pic --enable-postproc --prefix=/usr/local --target-os=linux --disable-doc --disable-debug --enable-vaapi --enable-libmfx --enable-encoder=h264_qsv --enable-decoder=h264_qsv --enable-encoder=hevc_qsv --enable-decoder=hevc_qsv --enable-hwaccel=h264_vaapi --enable-encoder=libaacplus --enable-gpl --enable-nonfree --enable-libaacplus --enable-librtmp --enable-static --enable-pthreads --enable-zlib --enable-encoder=libx264 --enable-libx264 --enable-encoder=libopenh264 --enable-libopenh264 --enable-muxer=h264 --extra-cflags='-fpic -I/opt/intel/mediasdk/include -I/home/gxh/works/huichang/svc_codec/bizconf_svc_codec/ffmpeg-linux/rtmpdump-2.4 -I/home/gxh/works/huichang/svc_codec/bizconf_svc_codec/ffmpeg-linux/libaacplus-2.0.2/include -I/home/gxh/works/huichang/svc_codec/bizconf_svc_codec/ffmpeg-linux/x264 -I/home/gxh/works/huichang/svc_codec/bizconf_svc_codec/ffmpeg-linux/openh264-1.5.0/include -I/home/gxh/works/huichang/svc_codec/bizconf_svc_codec/ffmpeg-linux/zlib-1.2.8 -I/home/gxh/works/huichang/svc_codec/bizconf_svc_codec/ffmpeg-linux/openssl-1.0.2d/include -I/usr/local/include' --extra-ldflags='-L/opt/intel/mediasdk/lib -L/home/gxh/works/huichang/svc_codec/bizconf_svc_codec/ffmpeg-linux/mylib -L/usr/local/lib' --extra-libs='-lmfx -laacplus -lx264 -lopenh264 -lcommon -lprocessing -lconsole_common -lz -ldl -lrtmp -lpthread -lstdc++ -lm'
prefix=/usr/local
...
CFLAGS=-fPIC  -fpic -I/opt/intel/mediasdk/include -I/home/gxh/works/huichang/svc_codec/bizconf_svc_codec/ffmpeg-linux/rtmpdump-2.4 -I/home/gxh/works/huichang/svc_codec/bizconf_svc_codec/ffmpeg-linux/libaacplus-2.0.2/include -I/home/gxh/works/huichang/svc_codec/bizconf_svc_codec/ffmpeg-linux/x264 -I/home/gxh/works/huichang/svc_codec/bizconf_svc_codec/ffmpeg-linux/openh264-1.5.0/include -I/home/gxh/works/huichang/svc_codec/bizconf_svc_codec/ffmpeg-linux/zlib-1.2.8 -I/home/gxh/works/huichang/svc_codec/bizconf_svc_codec/ffmpeg-linux/openssl-1.0.2d/include -I/usr/local/include -std=c11 -fomit-frame-pointer -fPIC -pthread  -I/opt/intel/mediasdk/include -I/opt/intel/mediasdk/include/mfx -I/usr/include/alsa     -I/usr/local/include -I/usr/local/include -I/usr/local/include -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-bool-operation -Wno-char-subscripts -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized -D_REENTRANT -I/usr/include/SDL2
CXXFLAGS=  -D__STDC_CONSTANT_MACROS -std=c++11
OBJCFLAGS=  
ASFLAGS=  -fpic -I/opt/intel/mediasdk/include -I/home/gxh/works/huichang/svc_codec/bizconf_svc_codec/ffmpeg-linux/rtmpdump-2.4 -I/home/gxh/works/huichang/svc_codec/bizconf_svc_codec/ffmpeg-linux/libaacplus-2.0.2/include -I/home/gxh/works/huichang/svc_codec/bizconf_svc_codec/ffmpeg-linux/x264 -I/home/gxh/works/huichang/svc_codec/bizconf_svc_codec/ffmpeg-linux/openh264-1.5.0/include -I/home/gxh/works/huichang/svc_codec/bizconf_svc_codec/ffmpeg-linux/zlib-1.2.8 -I/home/gxh/works/huichang/svc_codec/bizconf_svc_codec/ffmpeg-linux/openssl-1.0.2d/include -I/usr/local/include -fPIC
...
DEPWINDRES=gcc
DOXYGEN=doxygen
LDFLAGS= -L/opt/intel/mediasdk/lib -L/home/gxh/works/huichang/svc_codec/bizconf_svc_codec/ffmpeg-linux/mylib -L/usr/local/lib  -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=:libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
LDEXEFLAGS=
LDSOFLAGS=
...
EXTRALIBS=-lmfx -laacplus -lx264 -lopenh264 -lcommon -lprocessing -lconsole_common -lz -ldl -lrtmp -lpthread -lstdc++ -lm 
COMPAT_OBJS=
INSTALL=install
LIBTARGET=
...
avutil_FFLIBS=
EXTRALIBS-avdevice=-lm -lxcb -lxcb-shm -lxcb-shape -lxcb-xfixes -lasound -lSDL2 -lsndio -lXv -lX11 -lXext
EXTRALIBS-avfilter=-pthread -lm -L/usr/local/lib -lva -L/opt/intel/mediasdk/lib -lmfx -lstdc++ -ldl
EXTRALIBS-swscale=-lm
EXTRALIBS-postproc=-lm
EXTRALIBS-avformat=-lm -lbz2 -lz
EXTRALIBS-avcodec=-pthread -lm -llzma -lz -lx264 -pthread -lm -L/usr/local/lib -lva -L/opt/intel/mediasdk/lib -lmfx -lstdc++ -ldl
EXTRALIBS-swresample=-lm
EXTRALIBS-avresample=-lm
EXTRALIBS-avutil=-pthread -L/usr/local/lib -lva-drm -lva -L/usr/local/lib -lva-x11 -lva -lvdpau -lX11 -lm -L/opt/intel/mediasdk/lib -lmfx -lstdc++ -ldl -L/usr/local/lib -lva -lXv -lX11 -lXext
