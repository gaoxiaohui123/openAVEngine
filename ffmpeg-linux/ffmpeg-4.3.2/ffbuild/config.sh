...
LIBPREF=lib
LIBSUF=.a
extralibs_avutil="-pthread -L/usr/local/lib -lva-drm -lva -L/usr/local/lib -lva-x11 -lva -lvdpau -lX11 -lm -L/opt/intel/mediasdk/lib -lmfx -lstdc++ -ldl -L/usr/local/lib -lva -lXv -lX11 -lXext"
extralibs_avcodec="-pthread -lm -llzma -lz -lx264 -pthread -lm -L/usr/local/lib -lva -L/opt/intel/mediasdk/lib -lmfx -lstdc++ -ldl"
...
extralibs_avfilter="-pthread -lm -L/usr/local/lib -lva -L/opt/intel/mediasdk/lib -lmfx -lstdc++ -ldl"
