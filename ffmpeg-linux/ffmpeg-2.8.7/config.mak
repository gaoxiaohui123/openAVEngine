...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--enable-pic --enable-postproc --prefix=/usr/local --target-os=mingw32 --arch=x86_32 --disable-doc --disable-debug --enable-libmfx --enable-encoder=h264_qsv --enable-decoder=h264_qsv --enable-encoder=hevc_qsv --enable-decoder=hevc_qsv --enable-encoder=libaacplus --enable-gpl --enable-nonfree --enable-libaacplus --enable-librtmp --enable-static --enable-pthreads --enable-zlib --enable-encoder=libx264 --enable-libx264 --enable-encoder=libopenh264 --enable-libopenh264 --enable-muxer=h264 --extra-cflags='-fpic -I/home/gxh/works/huichang/svc_codec/bizconf_svc_codec/ffmpeg-linux/rtmpdump-2.4 -I/home/gxh/works/huichang/svc_codec/bizconf_svc_codec/ffmpeg-linux/libaacplus-2.0.2/include -I/home/gxh/works/huichang/svc_codec/bizconf_svc_codec/ffmpeg-linux/x264 -I/home/gxh/works/huichang/svc_codec/bizconf_svc_codec/ffmpeg-linux/openh264-1.5.0/include -I/home/gxh/works/huichang/svc_codec/bizconf_svc_codec/ffmpeg-linux/zlib-1.2.8 -I/home/gxh/works/huichang/svc_codec/bizconf_svc_codec/ffmpeg-linux/openssl-1.0.2d/include -I/usr/local/include' --extra-ldflags='-L/home/gxh/works/huichang/svc_codec/bizconf_svc_codec/ffmpeg-linux/mylib-win -L/mingw32/i686-w64-mingw32/mingw32/lib' --extra-libs='-lmfx -laacplus -lx264 -lopenh264 -lcommon -lprocessing -lconsole_common -lz -lrtmp -lstdc++ -lm'
prefix=/usr/local
...
CC_IDENT=gcc 10.2.0 (Rev5, Built by MSYS2 project)
ARCH=x86
INTRINSICS=none
CC=gcc
CXX=g++
...
CFLAGS=-fPIC  -fpic -I/home/gxh/works/huichang/svc_codec/bizconf_svc_codec/ffmpeg-linux/rtmpdump-2.4 -I/home/gxh/works/huichang/svc_codec/bizconf_svc_codec/ffmpeg-linux/libaacplus-2.0.2/include -I/home/gxh/works/huichang/svc_codec/bizconf_svc_codec/ffmpeg-linux/x264 -I/home/gxh/works/huichang/svc_codec/bizconf_svc_codec/ffmpeg-linux/openh264-1.5.0/include -I/home/gxh/works/huichang/svc_codec/bizconf_svc_codec/ffmpeg-linux/zlib-1.2.8 -I/home/gxh/works/huichang/svc_codec/bizconf_svc_codec/ffmpeg-linux/openssl-1.0.2d/include -I/usr/local/include -std=c99 -fomit-frame-pointer -pthread -I/mingw32/i686-w64-mingw32/mingw32/include -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized
...
DEPWINDRES=gcc
DOXYGEN=doxygen
LDFLAGS= -L/home/gxh/works/huichang/svc_codec/bizconf_svc_codec/ffmpeg-linux/mylib-win -L/mingw32/i686-w64-mingw32/mingw32/lib  -Wl,--nxcompat -Wl,--dynamicbase -Wl,--large-address-aware -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
LDEXEFLAGS=
LDLIBFLAGS=
SHFLAGS=-shared -Wl,--output-def,$$(@:$(SLIBSUF)=.orig.def) -Wl,--out-implib,$(SUBDIR)lib$(SLIBNAME:$(SLIBSUF)=.dll.a) -Wl,--enable-runtime-pseudo-reloc -Wl,--enable-auto-image-base -Wl,-Bsymbolic -Wl,--version-script,gxh.v
ASMSTRIPFLAGS= -wN '..@*'
YASMFLAGS=-f win32  -DPIC -DPREFIX
BUILDSUF=
PROGSSUF=
...
EXTRALIBS=-lavicap32 -lgdi32 -lpsapi -lole32 -lstrmiids -luuid -loleaut32 -lshlwapi -lws2_32 -liconv -lx264  -L/mingw32/i686-w64-mingw32/mingw32/lib -lmfx -lstdc++ -lole32 -luuid -laacplus -lm -llzma -lbz2 -pthread -lpsapi -ladvapi32 -lshell32 -lmfx -laacplus -lx264 -lopenh264 -lcommon -lprocessing -lconsole_common -lz -lrtmp -lstdc++ -lm 
COMPAT_OBJS=
EXEOBJS=
INSTALL=install
LIBTARGET=i386
