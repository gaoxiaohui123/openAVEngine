...
#define WZ264_API __declspec(dllexport)
#else
#define WZ264_API __attribute__((visibility("default")))
#endif
#endif
...
WZ264_API void wz264_param_default(wz264_param_t *);
...
#endif  // WZ264_SDK
WZ264_API int wz264_param_parse(wz264_param_t *, const char *name, const char *value);
...
WZ264_API int wz264_param_default_preset(wz264_param_t *, const char *preset, const char *tune);

/* wz264_param_apply_fastfirstpass:
 *      If first-pass mode is set (rc.b_stat_read == 0, rc.b_stat_write == 1),
 *      modify the encoder settings to disable options generally not useful on
 *      the first pass. */
WZ264_API void wz264_param_apply_fastfirstpass(wz264_param_t *);
...
WZ264_API int wz264_param_apply_profile(wz264_param_t *, const char *profile);
...
WZ264_API void wz264_picture_init(wz264_picture_t *pic);

/* wz264_picture_alloc:
 *  alloc data for a picture. You must call wz264_picture_clean on it.
 *  returns 0 on success, or -1 on malloc failure or invalid colorspace. */
WZ264_API int wz264_picture_alloc(wz264_picture_t *pic, int i_csp, int i_width, int i_height);

/* wz264_picture_clean:
 *  free associated resource for a wz264_picture_t allocated with
 *  wz264_picture_alloc ONLY */
WZ264_API void wz264_picture_clean(wz264_picture_t *pic);
...
WZ264_API wz264_t *wz264_encoder_open(wz264_param_t *);
 ...
 */
WZ264_API int wz264_encoder_reconfig(wz264_t *, wz264_param_t *);
...
WZ264_API void wz264_encoder_parameters(wz264_t *, wz264_param_t *);
...
WZ264_API int wz264_encoder_headers(wz264_t *, wz264_nal_t **pp_nal, int *pi_nal);
 ...
 *      the payloads of all output NALs are guaranteed to be sequential in memory. */
WZ264_API int wz264_encoder_encode(wz264_t *, wz264_nal_t **pp_nal, int *pi_nal,
                                   wz264_picture_t *pic_in, wz264_picture_t *pic_out);
/* wz264_encoder_close:
 *      close an encoder handler */
WZ264_API void wz264_encoder_close(wz264_t *);
/* wz264_encoder_delayed_frames:
 *      return the number of currently delayed (buffered) frames
 *      this should be used at the end of the stream, to know when you have all the encoded frames.
 */
WZ264_API int wz264_encoder_delayed_frames(wz264_t *);
/* wz264_encoder_maximum_delayed_frames( wz264_t * ):
 *      return the maximum number of delayed (buffered) frames that can occur with the current
 *      parameters. */
WZ264_API int wz264_encoder_maximum_delayed_frames(wz264_t *);
...
WZ264_API void wz264_encoder_intra_refresh(wz264_t *);
...
WZ264_API int wz264_encoder_invalidate_reference(wz264_t *, int64_t pts);
