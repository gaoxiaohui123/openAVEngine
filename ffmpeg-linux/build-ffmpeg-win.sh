...
--extra-cflags="-fpic -I$FFMPEG_ROOT/rtmpdump-2.4 -I$FFMPEG_ROOT/libaacplus-2.0.2/include -I$FFMPEG_ROOT/x264 -I$FFMPEG_ROOT/openh264-1.5.0/include -I$FFMPEG_ROOT/zlib-1.2.8 -I$FFMPEG_ROOT/openssl-1.0.2d/include -I/usr/local/include -I/usr/include" \
--extra-ldflags="-L$FFMPEG_ROOT/mylib-win -L$THIRD_PARTY_PATH/mingw32/lib -L$THIRD_PARTY_PATH/lib" \
--extra-libs="-lmfx -laacplus -lx264 -lopenh264 -lcommon -lprocessing -lconsole_common -lz -lrtmp -lstdc++ -lm -lpthread"

cd ../

#注意：--extra-cflags等里面的内容不能用斜杠换行
# -L/usr/local/lib/会导致错误，应该改为-L/usr/local/lib

#-L/home/../mingw32/i686-w64-mingw32/lib \
#-I/home/../mingw32/i686-w64-mingw32/include \
