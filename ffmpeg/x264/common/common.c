...
static int x264_param_apply_preset( x264_param_t *param, const char *preset )
{
    ...
    else if( !strcasecmp( preset, "superfast" ) )
    {
        ...
        param->analyse.i_me_range = 128;//64;//added by gxh
        param->i_frame_reference = 1;
        param->analyse.b_mixed_references = 0;
        param->analyse.i_trellis = 0;
        param->rc.b_mb_tree = 0;
        //param->analyse.i_weighted_pred = X264_WEIGHTP_SIMPLE;
        param->analyse.i_weighted_pred = X264_WEIGHTP_NONE;//added by gxh
        param->analyse.b_weighted_bipred = 0;
        param->rc.i_lookahead = 0;
    }
    else if( !strcasecmp( preset, "veryfast" ) )
    {
        ...
        param->rc.i_lookahead = 0;//added by gxh
    }
    else if( !strcasecmp( preset, "faster" ) )
    {
        param->analyse.i_me_method = X264_ME_UMH;//added by gxh
        param->analyse.b_mixed_references = 0;
        //param->i_frame_reference = 2;
        param->i_frame_reference = 1;//added by gxh
